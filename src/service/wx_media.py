...
def wx_media_get_byid(accessToken, mediaId):
...
def wx_voice_addvoicetorecofortext(accessToken, fileName, voiceId):
...
def wx_voice_queryrecoresultfortext(accessToken, voiceId):
...
def get_complete_voice_reco(accessToken, voiceId):
    result = wx_voice_queryrecoresultfortext(accessToken, voiceId)
